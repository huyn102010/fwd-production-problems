...
3. You can now change directories into `fwd-production-problems` and then the `pp-01` directory,
   ...
   My Production Problems repository URL: https://github.com/huyn102010/fwd-production-problems
...
8. Finallly, and most crucially, back on your command line, you need to add the course’s upstream
...
9. The instructor will access your Production Problems repository via
